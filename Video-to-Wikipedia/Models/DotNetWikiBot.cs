...
namespace DotNetWikiBot
{
    ...
    public class Site
    {
        ...
        public void GetPaths()
        {
            ...
            // added by gf
            string serverpath = @"e:\web\thegabrielf\htdocs\video-to-wikipedia\";
            var filePathName = serverpath + HttpUtility.UrlEncode(site.Replace("://", ".").Replace("/", ".")) + ".dat";
            
            //filePathName = System.Web.HttpContext.Current.Server.MapPath("");
            ...
            //Directory.CreateDirectory("Cache"); // commented by gf
            File.WriteAllText(filePathName, wikiPath + "\r\n" + indexPath + "\r\n" + xhtmlNSUri +
                "\r\n" + language + "\r\n" + langDirection + "\r\n" + site, Encoding.UTF8);

            logger.Info("finish getpaths");
        }
        ...
        public void GetModifiedMediaWikiMessages(bool forceLoad)
        {
            if (messages == null)
                messages = new PageList(this);
            string serverpath = @"e:\web\thegabrielf\htdocs\video-to-wikipedia\";
            string filePathName = serverpath + 
    ...
    public class Page
    {
        private ILog logger = log4net.LogManager.GetLogger(typeof(Page));
            ...
            string license, string copyStatus, string source)
        {
            ...
            {
                logger.Error("respStr exception in dnwb " + targetName + " encoded: " + HttpUtility.HtmlEncode(targetName)  
                    + "\n\n" + respStr);
                throw new WikiBotException(string.Format(
            ...
            try
            {
                ...
                {
                    logger.Error("second if - GetMediaWikiMessage");
    ...
    class XmlUrlResolverWithCache : XmlUrlResolver
    {
        ...
        static string cacheDir = @"e:\web\thegabrielf\htdocs\video-to-wikipedia\";
